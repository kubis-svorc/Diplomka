namespace Diplomka.Wrappers
{
    ...
    public static class KeywordContainer
    {
        ...
        {
            Keywords = new HashSet<string>(StringComparer.InvariantCultureIgnoreCase)
            {
                ...
                "husle", "bicie", "gitara", "organ", "spev", "trúbka", "harfa", "akordeón", "flauta", "klavír", "piano", "náhodný"
            };

            Headers = new HashSet<string>(StringComparer.InvariantCultureIgnoreCase)
            { 
                "opakuj", "ak", "inak", "urob", "vlákno", "koniec"
            };
